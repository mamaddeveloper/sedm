...
local function run(msg, matches)
  if matches[1]:lower() == 'pershia' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "pershia" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (pershia)",-- Put everything you like :)
		"^[!/]([Pp]ershia)"-- Put everything you like :)
    }, 
  run = run
}
